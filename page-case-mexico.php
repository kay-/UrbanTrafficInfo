...
<?php get_header(); ?>
	...
	<div id="content">
		<div class="banner-city">
			<img src="<?php echo get_template_directory_uri(); ?>/images/banner_mexico.jpg" alt="tokyo">
		</div>
			...
			<aside class="sub-city">
				...
				<div class="city-list">
					...
					<ul>
						...
						<li><a href="">Mexico City, Mexico <img src="<?php echo get_template_directory_uri(); ?>/images/dot_green.png" alt="current page icon"></a></li>
