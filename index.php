	...
	<div id="content">
		...
		<div class="main">
			...
			<div class="home-col case">
				<h2>Case Study</h2>
				<article><a href="http://urbantraffic.info/case-tokyo">
					<section class="title">Urban Traffic in Tokyo</section>
					<section class="summary">Tokyo has been solving its problems in public transit by developing technologies and operations to sustain tens of million users, especially trains and subway.</section></a>
				</article>

				<article><a href="http://urbantraffic.info/case-seoul">
					<section class="title">Urban Traffic in Seoul</section>
					<section class="summary">Seoul has a great urban public transportation system to handling about a million people per day. They have done massive upgrade in 2004. After then, the usage of the public transportation rate in Seoul increased 30%. Seoul public transportation uses lots of high technology from seatlight tracking to payment system.</section></a>
				</article>

				<article><a href="http://urbantraffic.info/case-mexico">
